...
export default function ResaleLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex flex-col h-full">
      <div className="border-b border-zinc-200 dark:border-white/[0.08] bg-white dark:bg-zinc-900 px-5 pt-0 pb-0 shrink-0">
        <div className="flex items-end gap-4">
          {/* Título alinhado com as tabs */}
          <span className="text-sm font-semibold text-zinc-800 dark:text-zinc-100 pb-2.5 shrink-0">
            Revenda
          </span>
