...
export default function ResalePage() {
  ...
  return (
    <div className="p-3 sm:p-4 flex flex-col gap-3 md:overflow-hidden md:h-full">
      ...
      <div className="sticky top-0 z-10 -mx-3 sm:-mx-4 px-3 sm:px-4 pt-2 sm:pt-3 pb-2 -mt-3 sm:-mt-4 bg-zinc-50 dark:bg-zinc-950 border-b border-zinc-200 dark:border-white/[0.08] shadow-sm shrink-0">
