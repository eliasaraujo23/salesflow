...
import { JmEstoqueTab } from '@/components/fabricacoes-jm/jm-estoque-tab';
...
type Tab = 'estoque' | 'modificacao' | 'vendas';

const TABS: { key: Tab; label: string; icon: React.ReactNode }[] = [
  { key: 'estoque',    label: 'Estoque',     icon: <Archive size={14} /> },
  { key: 'modificacao', label: 'Modificação', icon: <TableProperties size={14} /> },
        ...
        <>
          {activeTab === 'estoque' && (
            <>
              ...
              <JmEstoqueTab data={data.listaEstoque} />
            </>
          )}
